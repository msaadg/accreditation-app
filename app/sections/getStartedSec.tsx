export const GetStartedSec = () => {
  return <div className='bg-blue-gray-900 flex justify-around'>
    ...
    <div className='flex text-xl font-semibold text-red-600 py-6 hover:cursor-pointer'>
      About GSA Council
    ...
    <div className='flex text-xl font-semibold text-blue-400 py-6 hover:cursor-pointer'>
