export const QuickLinks = ({ email, phone, address } : {
  email: string;
  phone: string;
  address: string;
}) => {
  return (
    <div className="grid grid-cols-9 justify-between gap-8 px-16 py-16 bg-blue-gray-900 text-white">
      <div className="col-span-4">
        ...
        <div className="pt-6 flex justify-between">
          <div className="">
            <div className="hover:text-customOrange py-2 hover:cursor-pointer">About GSA Council</div>
            <div className="hover:text-customOrange py-2 hover:cursor-pointer">Educational Accreditation</div>
            <div className="hover:text-customOrange py-2 hover:cursor-pointer">Professional Accreditation</div>
            <div className="hover:text-customOrange py-2 hover:cursor-pointer">Chapter Members</div>
            <div className="hover:text-customOrange py-2 hover:cursor-pointer">Become A Chapter Member</div>
          </div>

          <div>
            <div className="hover:text-customOrange py-2 hover:cursor-pointer">Accreditation Criteria for Institutes</div>
            <div className="hover:text-customOrange py-2 hover:cursor-pointer">Accredited Institutes</div>
            <div className="hover:text-customOrange py-2 hover:cursor-pointer">Accreditation Professionals</div>
            <div className="hover:text-customOrange py-2 hover:cursor-pointer">Accreditation Process For Institutes</div>
            <div className="hover:text-customOrange py-2 hover:cursor-pointer">Accreditation Process For Professionals</div>
          </div>
        </div>
      </div>
      ...
      <div className="col-span-2">
        ...
        <div className="pt-6">
          ...
          <div className="flex">
            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 50 50" className="hover:cursor-pointer">
