export const RegisterCardTop = ({ onClose } : {
  ...
  return (
    <div className="relative flex flex-col justify-between border-customOrange border-4 text-6xl bg-gray-500 opacity-95 max-w-lg p-12 rounded-lg shadow-lg">
      <button
        className="text-xl absolute top-4 right-4 bg-red-500 text-white rounded-full w-8 h-8 flex items-center justify-center"
        onClick={onClose}
      >
        &times;
      </button>
      ...
      <div className="mt-6">
        <form className="max-w-full">
          <select
            id="countries"
            className="bg-gray-50 border border-gray-300 text-black text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full h-16 p-4"
          >
        ...
        <input
          ...
          className="w-full bg-gray-50 border border-gray-300 text-black text-sm rounded-lg h-16 p-4 mt-4"
        />
        <input
        ...
        <form className="max-w-full mx-auto relative mt-4">
          ...
          <input
            ...
            className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full h-16 ps-10 p-4 "
        ...
        <div className="mt-8 mb-2 text-sm flex justify-center">
          <div className="text-gray-800">Are you a registered member?</div>
          <div className="text-blue-900 hover:cursor-pointer ml-1">Login</div>
        </div>
